...
model_root = "../cache_huggingface/models--THUDM--chatglm2-6b/snapshots/b1502f4f75c71499a3d566b14463edd62620ce9f"
tokenizer = AutoTokenizer.from_pretrained(model_root, trust_remote_code=True)
model = AutoModel.from_pretrained(model_root, trust_remote_code=True).half().cuda()
...
# queries = ['晚上睡不着怎么办','clear','晚上睡不着怎么办','clear','晚上睡不着怎么办','clear','晚上睡不着怎么办','clear','晚上睡不着怎么办']
