...
```shell
cd Model-References/PyTorch/nlp/ChatGLM2-6B
pip install -r requirements.txt 
```
...
python cli_demo.py
```
- Replace default modeling scripts (e.g. ~/.cache/huggingface/hub/models--THUDM--chatglm2-6b/snapshots/*/) with scripts in forked Model-References/PyTorch/nlp/ChatGLM2-6B/models--THUDM--chatglm2-6b
